...
def get_Typer():
	...
	global fake_ip
	global hides
	optp = OptionParser(add_help_option=False,epilog="313-DDos")
...
def usage1():
	...
	usage : python 313DDos.py [-i] [-p] [-l]
            ...
            -d : Hide message
	example :
	    python 313DDos.py -i 12.345.678 -p 80 -l 2"""
    md = Markdown(MARKDOWN)
    console.print(md,style="bold green")
    #sys.exit()
...
def usage3():
    console = Console()
    MARKDOWN="""
    Programmer : Dr Clxzner
    Made in : Palestine
    Instagram : @clxzner
    github : https://github.com/Clxzner/313-DDos
    Tool Information : I Was Specially Made To Destroy Isl@m  Haters
"""
    md = Markdown(MARKDOWN)
    console.print(md,style="bold green")
